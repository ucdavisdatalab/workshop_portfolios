...
```{r, echo=FALSE, fig.alt="Black and white Noun Project Icon showing two women shaking hands", out.width="25%"}
knitr::include_graphics("./images/noun-respect-2909352.png")
```
...
Define for your reviewers the areas you want feedback on, and be clear about what types of comments you're looking for. Discuss the goals of your portfolio with your reviewers. Consider asking for feedback in the following areas:
...
* Does the portfolio reflect your goals?

```{r, echo=FALSE, fig.alt="Black and white Noun Project Icon showing a woman holding a small person in each hand, listening", out.width="25%"}
knitr::include_graphics("./images/noun-mentor-2909349.png")
```

## Using Feedback

Receiving feedback can be difficult, especially when it pertains to a project you have worked hard on, like developing a digital portfolio. Try to remember that the feedback you receive is about the product and that your reviewers want to help you. **Ground your decisions about using feedback in the goals you set for your portfolio.**
