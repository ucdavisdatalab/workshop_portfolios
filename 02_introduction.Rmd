...
```{r, echo=FALSE, fig.alt="Black and white Noun Project Icon showing a woman juggling many skill icons - money, time, a computer, and a pen", out.width="25%", out.extra='style="float:right; padding:10px"'}
