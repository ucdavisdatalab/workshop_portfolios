...
A portfolio isn't a CV. It shouldn't be a catalog of everything you have ever done, but rather, it should be a collection of your best work. But most of all, it should communicate something about you to the viewer.

Yes, your overall goal for this process is probably to get a job, but that's not exactly what we mean.  

A clear goal should be achievable and specific. Below are some examples of achievable, specific goals:
...
ACTIVITY 1 (Introspective; paste it into the chat): write down 1-2  goals for your portfolio. What do you want the viewer to learn about you?
